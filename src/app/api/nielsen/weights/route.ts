...
import { getTopWeightsFromSession, DynamicFilter } from '@/lib/nielsen-processor';
...
export async function GET(request: NextRequest) {
  ...
  const weights = getTopWeightsFromSession(markets, categories, years, packageTypes, sourceFiles, 5, filters);
