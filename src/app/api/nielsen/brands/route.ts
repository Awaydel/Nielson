...
import { getTopBrandsFromSession, applyDynamicFilters, DynamicFilter } from '@/lib/nielsen-processor';
...
export async function GET(request: NextRequest) {
  ...
  const brands = getTopBrandsFromSession(markets, categories, years, packageTypes, sourceFiles, 10, filters);
