...
import { getTopVariantsFromSession, DynamicFilter } from '@/lib/nielsen-processor';
...
export async function GET(request: NextRequest) {
  ...
  const variants = getTopVariantsFromSession(markets, categories, years, packageTypes, sourceFiles, 10, filters);
